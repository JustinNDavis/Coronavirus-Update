...
#this function deletes the old content from the previous day
def PrepareMessage():

    #opens file and for writing
    file = open("message.txt", "w")
    file.write("Good morning Justin, here are the latest totals for Coronavirus: \n\n")
    file.close()

#this functions scrapes the new counts
def NewCount():

    #opens file and assigns its contents to variable named file
    ...
    #list for the numbers beings stored
    numbers = []
...
#This function gets the total counts
def TotalCount():
    file = open("message.txt", "a")
...
#this function creates an SMTP object and sends an email
def PrepareEmail():

    #assistance provided through Arjun Krishna Babu on freeCodeCamp
    #CONSTANTS
    MY_ADDRESS = "name@place.com"
    PASSWORD = "PASSWORD"
